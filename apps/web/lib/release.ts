export const windowsRelease = {
  ...
  installerUrl: "https://github.com/alibad/OpenRA-AI/releases/download/v0.1.0-alpha.12/OpenRA-AI-0.1.0-alpha.12-windows-x64-setup.exe",
  portableUrl: "https://github.com/alibad/OpenRA-AI/releases/download/v0.1.0-alpha.12/OpenRA-AI-0.1.0-alpha.12-windows-x64.zip",
