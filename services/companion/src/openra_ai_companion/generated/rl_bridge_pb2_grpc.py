...
from . import rl_bridge_pb2 as rl__bridge__pb2
...
class RLBridgeStub:
    ...
    def __init__(self, channel):
        ...
        self.Observe = channel.unary_unary(
                '/openra.rl.RLBridge/Observe',
                request_serializer=rl__bridge__pb2.StateRequest.SerializeToString,
                response_deserializer=rl__bridge__pb2.GameObservation.FromString,
                _registered_method=True)
        self.UpdateCompanionStatus = channel.unary_unary(
...
class RLBridgeServicer:
    ...
    def UpdateCompanionStatus(self, request, context):
...
def add_RLBridgeServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'UpdateCompanionStatus': grpc.unary_unary_rpc_method_handler(
...
class RLBridge:
    ...
    @staticmethod
    def UpdateCompanionStatus(request,
            target,
            options=(),
            channel_credentials=None,
            call_credentials=None,
